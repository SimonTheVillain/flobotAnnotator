...
bag_in = rosbag.Bag('/home/simon/datasets/flobot/carugate/freezer_section_dirt/2018-04-18-10-20-53.bag','r')#this is a valid rosbag at least!!!
...
def generate_new_rosbag(result_bag_path,bag_in,annotator):
    bridge = CvBridge()
    bag_out = rosbag.Bag(result_path,'w')
...
if load_annotation_from_file:
    annotator.load(annotation_file)

annotations = collections.OrderedDict()

if render_result_to_file:
    generate_new_rosbag(result_path,bag_in,annotator)
...
currentIndex = 0
while running:
    #todo: fetch next frame from list
    ...
    if key == 32:  # space
        ...
        annotator.store(annotation_file)
        pass
    elif key == 101: #e
